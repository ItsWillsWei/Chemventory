...
public class ChemventoryFrame extends JPanel {
	...
	public JPanel createBulletinPanel() {
		...
		messageButtons.setLayout(new FlowLayout());
		JButton addMessage = new JButton("Add Message");
		messageButtons.add(addMessage);
		...
		addMessage.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				//Add the new message
				String message = BACKUP_DATE_FORMAT.format(new Date()) + "\n" + JOptionPane
		...
		// Check to see if other people have sent messages
		JButton refreshBulletin = new JButton("Refresh Messages");
		messageButtons.add(refreshBulletin);
		refreshBulletin.requestFocus();
		refreshBulletin.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0)
			{
				try {
					readArrays();
